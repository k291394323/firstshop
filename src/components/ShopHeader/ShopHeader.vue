  ...
  <div class="shop-header">
    ...
    <div class="shop-content" @click="getShopShow">
      ...
      <div class="header-content" >
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">月{{info.sellCount}}售单</span>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="getSupportShow" >
      <div class="discounts-left">
        <div class="activity"  >
          <span class="content-tag" :class="SupportsClasses[info.supports[0].type]">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow" >
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item" v-for="(item,index) in info.supports" :class="SupportsClasses[item.type]" :key="index"
               >
            <span class="content-tag" >
                <span class="mini-tag">
                    {{item.name}}
